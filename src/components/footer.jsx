...
export default function Footer() {
  return (
    <footer id="footer-section" className="bg-gray-900 text-white pt-10 pb-5">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:flex flex-wrap lg:justify-evenly">

        <div className="flex items-center space-x-3">
          <img src={logo} alt="The Green Sprout" className="h-12 w-auto" />
        </div>


        <div>
          <h4 className="text-green-400 text-lg font-semibold mb-4">Contact Us</h4>
          ...
          <p>
            <a href="mailto:hello@thegreensprout.com" className="text-green-300 hover:underline">hello@thegreensprout.com</a>
          </p>
        </div>
        ...
        <div>
          <h4 className="text-green-400 text-lg font-semibold mb-4">Follow Us</h4>
          <div className="flex space-x-4">
            <a href="https://facebook.com" target="_blank" className="hover:text-green-300 w-[30px]">
            ...
            <a href="https://instagram.com" target="_blank" className="hover:text-green-300 w-[30px]">
            ...
            <a href="https://twitter.com" target="_blank" className="hover:text-green-300 w-[30px]">

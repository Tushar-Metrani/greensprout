...
export default function Footer() {
  return (
    <footer id="footer-section" className="bg-gray-100 text-black pt-10">
      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:flex flex-wrap justify-center sm:justify-evenly">
        ...
        <div className="text-sm lg:text-base">
          <h4 className="text-green-700 font-semibold mb-4">Contact Us</h4>
          <p className="mb-1"><b>The Green Sprout</b></p>
          <p className="mb-1">808 Tofu Lane <br/>Greenville, Earth 31415</p>
          <p className="mb-1">
            <a href="tel:+99 808 01010" className="text-green-700 hover:underline">+99 808 01010</a>
          </p>
          <p>
            <a href="mailto:hello@thegreensprout.com" className="text-green-700 hover:underline">thegreensproutcontact@gmail.com</a>
          </p>
        </div>

        <div className="text-sm lg:text-base">
          <h4 className="text-green-700 font-semibold mb-4">Opening Hours</h4>
        ...
        <div className="flex flex-col quicksand-font text-sm lg:text-base">
          <h4 className="text-green-700 font-semibold mb-2">Quick Links</h4>

          <Link to="/home?section=hero" className="hover:text-gray-700 p-1">Home</Link>

          <Link to="/home?section=about" className="hover:text-gray-700 p-1">About</Link>

          <Link to="/home?section=menu" className="hover:text-gray-700 p-1">Menu</Link>

          <Link to="/bookTable?section=bookTable-section" className="hover:text-gray-700 p-1 ">Book table</Link>
        </div>

        <div>
          <h4 className="text-green-700 text-left sm:text-center text-sm lg:text-base font-semibold mb-4">Follow Us</h4>
          <div className="flex space-x-4">
            <a href="https://facebook.com" target="_blank" className="hover:text-green-900 w-[24px] lg:w-[30px]" aria-label="facebook-link">
            ...
            <a href="https://instagram.com" target="_blank" className="hover:text-green-300 w-[24px] lg:w-[30px]" aria-label="instagram-link">
            ...
            <a href="https://twitter.com" target="_blank" className="hover:text-green-300 w-[24px] lg:w-[30px]" aria-label="twitter-link">
      ...
      <div className="d-flex border-t border-gray-700 mt-10 py-3 sm:py-4 text-center text-sm md:text-base text-gray-900 text-wrap">

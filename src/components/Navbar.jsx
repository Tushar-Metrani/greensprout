...
export default function Navbar(props) {
    ...
    return (
        <>
            <div id="Navbar" className="flex items-center bg-white justify-between py-2 px-5 md:px-10 shadow-md md:justify-between sticky top-0 z-1 quicksand-font">
                ...
                <div id="logo" className="w-35 md:w-2/11 lg:w-1/8">
                    <img src={logo}></img>
                </div>
                ...
                <div id="sm-menu-links" className={`${navDisplay === false ? "hidden" : ""} text-gray-800 flex flex-row items-start fixed sm:hidden bg-gray-200 right-0 top-0 w-40 h-70 py-3`}>

import teamphoto from '../../src/assets/GroupOfpeople.jpg'
export default function Aboutsection(){
    return(
        <div id="about-section" className="flex flex-wrap justify-center items-center px-5 py-5 md:px-10 md:py-15 bg-white">
        <h2 className='text-xl w-[100%] mb-4 md:hidden playfair-display-font md:text-2xl'>About us</h2>
        ...
        <div id="about-text" className='my-7 sm:mx-5 md:mx-10'>
          <h2 className='text-2xl hidden md:block playfair-display-font md:text-2xl'>About us</h2>
        <p className='text-justify text-[15px] quicksand-font max-w-[580px] sm:max-w-[300px] md:max-w-[500px] xl:max-w-[700px] md:my-5 md:text-base'>
